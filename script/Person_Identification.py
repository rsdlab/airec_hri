...
directry = home_path +"/catkin_ws/src/rois_env/voice/identification.mp3"
file_path = home_path + '/catkin_ws/src/sensor_system/person_id.yml'
...
if __name__ == "__main__":
    ...
    service = Person_IdentificationService(robotname)
    service.run()
